...
<div class="left-panel" style="width:50%; display:flex; flex-direction:column; justify-content:space-between; padding:40px 48px;">
    ...
    <div style="position:relative; z-index:10;">
        <h1 style="color:white; font-size:34px; font-weight:800; line-height:1.2; margin:0 0 12px;">
            Hampir Selesai!<br>
            <span style="color:#93c5fd;">Verifikasi Email Anda 🔐</span>
        </h1>
        <p style="color:#bfdbfe; font-size:14px; line-height:1.7; margin:0 0 28px; max-width:300px;">
            Kami telah mengirim kode OTP 6 digit ke email Anda. Masukkan kode tersebut untuk mengaktifkan akun.
        </p>

        {{-- Step progress --}}
        <div class="glass-card float" style="padding:20px; max-width:310px; margin-bottom:20px;">
            <p style="color:#93c5fd; font-size:11px; font-weight:600; letter-spacing:0.06em; text-transform:uppercase; margin:0 0 16px;">Progress Pendaftaran</p>
            <div style="display:flex; align-items:center; gap:6px;">
                ...
                <div style="display:flex; flex-direction:column; align-items:center; gap:4px;">
                    ...
                    <p style="color:#4ade80; font-size:10px; font-weight:600; margin:0; text-align:center;">Data<br>Akun</p>
                </div>
                ...
                <div style="display:flex; flex-direction:column; align-items:center; gap:4px;">
                    ...
                    <p style="color:#93c5fd; font-size:10px; font-weight:600; margin:0; text-align:center;">Akun<br>Aktif</p>
                </div>
            </div>
        </div>
...
<div style="width:50%; background:#f8fafc; display:flex; align-items:center; justify-content:center; padding:40px 24px; overflow-y:auto;">
    <div style="width:100%; max-width:420px;">
        ...
        <div style="margin-top:24px; text-align:center;">
            ...
            <form method="POST" action="{{ route('register.otp.resend') }}" id="resend-form">
                @csrf
