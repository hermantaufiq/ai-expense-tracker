...
<head>
    ...
    <title>Lupa Password – AI Expense Tracker</title>
...
<div style="width:50%; background:#f8fafc; display:flex; align-items:center; justify-content:center; padding:40px 24px;">
    <div style="width:100%; max-width:400px;">
        ...
        <div style="margin-bottom:28px;">
            <h2 style="font-size:26px; font-weight:800; color:#0f172a; margin:0 0 6px;">Lupa Password? 🔐</h2>
            <p style="font-size:14px; color:#64748b; margin:0;">Jangan khawatir. Masukkan email Anda dan kami akan mengirimkan kode OTP untuk reset password.</p>
        </div>
