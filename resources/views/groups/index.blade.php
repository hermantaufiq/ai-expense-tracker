        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="flex justify-between items-center">
                ...
                <button x-data="" x-on:click.prevent="$dispatch('open-modal', 'create-group')"
                    class="px-5 py-2.5 bg-primary-600 hover:bg-primary-700 text-white text-sm font-semibold rounded-xl shadow-sm hover:shadow-md transition">
                    + Buat Grup Baru
                </button>
            </div>
            ...
            @else
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
                    @foreach($groups as $group)
                        <a href="{{ route('groups.show', $group) }}" class="block bg-white dark:bg-gray-800 rounded-2xl shadow-soft hover:shadow-soft-lg transition-all duration-300 overflow-hidden border border-gray-100 dark:border-gray-700 hover:border-primary-300 dark:hover:border-primary-700 hover:-translate-y-1">
                            <div class="p-6">
                                <div class="flex items-center gap-3 mb-4">
                                    <div class="w-12 h-12 rounded-2xl bg-gradient-to-br from-primary-500 to-primary-700 flex items-center justify-center text-white font-bold text-xl shadow-sm">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                                            @if($group->owner_id === auth()->id())
                                                <span class="text-primary-600 dark:text-primary-400 font-semibold bg-primary-50 dark:bg-primary-900/30 px-2 py-0.5 rounded-md">Pemilik</span>
                                            @else
                                ...
                                <div class="flex justify-between items-center text-sm text-gray-600 dark:text-gray-400 border-t border-gray-100 dark:border-gray-700 pt-4 mt-2">
                                    ...
                                    <span class="text-primary-600 dark:text-primary-400 font-bold group-hover:translate-x-1 transition-transform">Buka &rarr;</span>
                                </div>
                            </div>
                        </a>
                    @endforeach
